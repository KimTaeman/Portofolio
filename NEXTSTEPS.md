...
- Scene 3 now begins with a continuously visible valley: two flattened low-poly side hills overlap a buried central grass base beneath the pink-and-white stone path, which physically overlaps the Campus path. Small setback pines gradually grow into the dense Scene 3 forest. Deeper in the valley, a rocky spring on the tall right ridge feeds a detached waterfall and aligned confined river far below the protected trail; the route continues past the suspension bridge and six gently bobbing project balloons with proximity-driven cards.
...
- [x] Match the Campus grass and Mountain side hills through one shared low-poly material, physically overlap the Campus path and first pink transition stone at the same top height, taper the blossoms, and stage pines outside a protected center corridor.
