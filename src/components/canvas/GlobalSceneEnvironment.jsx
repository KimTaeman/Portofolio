...
const DAY = Object.freeze({
  ...
  celestial: new THREE.Color('#FFD15C'),
  celestialGlow: new THREE.Color('#FFE58F'),
})
...
const celestialOffset = new THREE.Vector3(28, 24, -120)
const celestialWorldOffset = new THREE.Vector3()
...
export default function GlobalSceneEnvironment() {
  ...
  useFrame((_, delta) => {
    ...
    if (celestialRef.current) {
      celestialWorldOffset
        .copy(celestialOffset)
        .applyQuaternion(camera.quaternion)
      celestialRef.current.position
        .copy(camera.position)
        .add(celestialWorldOffset)
    }
  ...
  return (
    <>
      ...
      <directionalLight
        ...
        shadow-radius={4}
      />
      <mesh ref={celestialRef} name="globalSunMoon" renderOrder={-10}>
        <sphereGeometry args={[9, 28, 22]} />
